...
(:init
  ...
  (= (test-medium tester_ssr_1 t1) 10)
  (= (test-medium tester_ssr_1 t2) 3)
  (= (test-medium tester_ssr_1 t3) 10)
  (= (test-medium tester_ssr_1 t4) 10)
  (= (test-medium tester_ssr_1 t5) 3)
  (= (test-medium tester_ssr_1 t6) 12)
  (= (test-medium tester_ssr_1 t7) 25)
  (= (test-medium tester_ssr_1 t8) 25)
  (= (test-medium tester_ssr_1 t9) 36)
  (= (test-medium tester_ssr_1 t10) 12)
  (= (test-medium tester_ssr_1 t11) 18)
  (= (test-medium tester_ssr_1 t12) 24)
  (= (test-medium tester_ssr_1 t13) 17)
  (= (test-medium tester_ssr_1 t14) 35)
