...
(:init
  ...
  (task-in t1 creada) (task-in t2 creada) (task-in t3 creada)
  (task-in t4 creada) (task-in t5 creada)

  (role-in dev_jr_1 libre) (role-in tester_jr libre) (role-in tester_ssr libre) (role-in tester_sr libre)
  (role-in dev_sr_1 libre) (role-in dev_sr_2 libre) (role-in dev_sr_3 libre)

  (not (assigned-to t1 dev_jr_1  )) (not (assigned-to t1 dev_sr_1)) (not (assigned-to t1 dev_sr_2 ))
  (not (assigned-to t1 dev_sr_3  )) (not (assigned-to t1 tester_jr))
  (not (assigned-to t1 tester_ssr)) (not (assigned-to t1 tester_sr))

  (not (assigned-to t2 dev_jr_1 )) (not (assigned-to t2 dev_sr_1 )) (not (assigned-to t2 dev_sr_2  ))
  (not (assigned-to t2 dev_sr_3 )) (not (assigned-to t2 tester_jr)) (not (assigned-to t2 tester_ssr))
  (not (assigned-to t2 tester_sr))

  (not (assigned-to t3 dev_jr_1)) (not (assigned-to t3 dev_sr_1 ))  (not(assigned-to t3 dev_sr_2))
  (not (assigned-to t3 dev_sr_3)) (not (assigned-to t3 tester_jr )) (not(assigned-to t3 tester_ssr))
  ...
  (= (test-medium tester_ssr t3) 10) (= (test-medium tester_ssr t4) 18)
  (= (test-medium tester_ssr t5) 6)  (= (test-slow tester_jr t1) 22)
  (= (test-slow tester_jr t2) 17)    (= (test-slow tester_jr t3) 10)
